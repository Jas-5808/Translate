...
const convertTxtToPdf = async () => {
    ...
    return (
        ...
        <div className={cn.description}>
            ...
            <p>На этой странице пользователи могут легко конвертировать изображения из одного формата в другой. Конвертер поддерживает популярные форматы, такие как JPEG, PNG, GIF и другие, что делает его идеальным инструментом для быстрой и качественной обработки изображений под нужды пользователей. Этот инструмент поможет вам подготовить изображения для сайтов, социальных сетей и других платформ с минимальными усилиями.</p>
        </div>
